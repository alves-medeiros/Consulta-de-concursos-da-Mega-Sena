...
function renderDraw(data) {
  result.innerHTML = `
    ...
    ${data.ganhadores_6_acertos} ganhador(es), ${formatCurrency(
    data.rateio_6_acertos
  )}
  </div>
  <div class="detail">
    <strong>5 acertos</strong>
    ${data.ganhadores_5_acertos} ganhador(es), ${formatCurrency(
    data.rateio_5_acertos
  )}
  </div>
  <div class="detail">
    <strong>4 acertos</strong>
    ${data.ganhadores_4_acertos} ganhador(es), ${formatCurrency(
    data.rateio_6_acertos
  )}
  </div>
  <div class="detail">
